...
class OcrWorker(BaseWorker):
    ...
    def process_message(self, ch, method, properties, body):
        ...
        try:
            ...
            self.logger.debug(f"Processing ocr request for image {image_id}")
            ...
            self.logger.info(f"Successfully processed ocr request for image {image_id}")
            
        except Exception as e:
            self.logger.error(f"Error processing ocr message: {e}")
            # Reject and requeue
