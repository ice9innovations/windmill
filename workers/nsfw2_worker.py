...
class Nsfw2Worker(BaseWorker):
    ...
    def process_message(self, ch, method, properties, body):
        ...
        try:
            ...
            self.logger.debug(f"Processing nsfw2 request for image {image_id}")
            ...
            self.logger.info(f"Successfully processed nsfw2 request for image {image_id}")
            
        except Exception as e:
            self.logger.error(f"Error processing nsfw2 message: {e}")
            # Reject and requeue
