...
class RtdetrWorker(BaseWorker):
    ...
    def process_message(self, ch, method, properties, body):
        ...
        try:
            ...
            self.logger.debug(f"Processing rtdetr request for image {image_id}")
            ...
            self.logger.info(f"Successfully processed rtdetr request for image {image_id}")
            
        except Exception as e:
            self.logger.error(f"Error processing rtdetr message: {e}")
            # Reject and requeue
